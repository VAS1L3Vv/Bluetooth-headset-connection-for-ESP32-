...
{
    int16_t * bt_microphone_buf = (int16_t*)malloc(FRAME_SIZE);
    int16_t * bt_speaker_buf = (int16_t*)malloc(FRAME_SIZE);
    setup_audio(bt_microphone_buf, bt_speaker_buf, SECONDS_TO_BYTES); // одноразовый инит тут
